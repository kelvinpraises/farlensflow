export const promptTemplate = (interest: string) => {
  ...
  3. Use the following template to understand what the user need, replacing {SPECIFIC_INTEREST} with the user's exact words:
  ...
  4. After parsing this initial response, your ongoing task is to:
